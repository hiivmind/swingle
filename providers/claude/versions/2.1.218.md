> Distilled: claude 2.1.218 truth, assembled 2026-08-01 from commit 84580d1 (pack body at stamp 2.1.218), providers/claude/verification-log.md entries dated 2026-07-24 and 2026-07-25. Not a byte snapshot.
...
| `< /dev/null` needed | No — every probe ran without a stdin redirect and none hung. |
