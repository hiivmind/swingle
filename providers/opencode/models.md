...
`opencode/nemotron-3-ultra-free` — ❌ rejected (2026-07-22). See the [provider verification log](verification-log.md) for the reviewer and implementer probe findings.
...
- **2026-07-21 — Google**: Gemini **3.6 Flash** (new workhorse), **3.5 Flash-Lite**
  ...
  Source: blog.google announcement. Table moved all agy Flash rows 3.5 → 3.6 same week. (mirror)
