# claude models (Anthropic seat) — verified dispatching 2026-07-31
...
resolved snapshot at verification time (2.1.220, 2026-07-31) was `haiku`→claude-haiku-4-5-20251001,
`sonnet`→claude-sonnet-5, `opus`→claude-opus-5 (changed in cli 2.1.219; was claude-opus-4-8).
...
- **Review lane: clears P13 with the ≥ v1.9.2 contract (P13, 2026-07-25; re-verified for opus=claude-opus-5, 2026-07-31).** sonnet and opus
  ...
  **Important** and flipped the assessment to Needs fixes (4/4). So the review lane now clears
  P13 with the current contract. The opus alias now resolves to claude-opus-5 (1M context);
  P13 was re-run 2/2 Important on claude-opus-5 (2026-07-31) — result unchanged. It remains a
  prompt mitigation, not a guarantee — keep severity adjudication in the controller. Full
  before/after in the two 2026-07-25 entries of [verification-log.md](verification-log.md).
  haiku (cheapest) is not a review tier.
