> Distilled: pi 0.81.1 truth, assembled 2026-08-01 from commit a22b9b0 (pack body at stamp 0.81.1), providers/pi/verification-log.md entry dated 2026-07-24. Not a byte snapshot.
...
| `< /dev/null` needed | No — harmless insurance. |
...
- **No stdin hang**: `< /dev/null>` is harmless insurance for headless dispatches.
